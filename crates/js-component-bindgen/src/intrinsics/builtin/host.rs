...
impl super::BuiltinIntrinsicRenderer {
    /// Render a [`HostIntrinsic`]
    pub(crate) fn render_host(
        &self,
        intrinsic: &HostIntrinsic,
        output: &mut Source,
        ...
        match intrinsic {
            ...
            //
            HostIntrinsic::PrepareCall => {
                let debug_log_fn = Intrinsic::DebugLog.name();
                let prepare_call_fn = HostIntrinsic::PrepareCall.name();
            ...
            HostIntrinsic::AsyncStartCall => {
                let debug_log_fn = Intrinsic::DebugLog.name();
                let async_start_call_fn = HostIntrinsic::AsyncStartCall.name();
            ...
            HostIntrinsic::SyncStartCall => {
                let debug_log_fn = Intrinsic::DebugLog.name();
                let sync_start_call_fn = HostIntrinsic::SyncStartCall.name();
                output.push_str(&format!(
                    "
