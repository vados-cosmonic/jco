...
function getJson(arg0, arg1) {
  ...
  const ret = exports1['example:browser-fetch/ping#get-json'](ptr0, len0, variant2_0, variant2_1, variant2_2);
  let variant4;
  ...
  var ptr6 = dataView(memory0).getInt32(ret + 20, true);
  var len6 = dataView(memory0).getInt32(ret + 24, true);
  var result6 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr6, len6));
  const retVal = {
    name: variant4,
    url: result5,
    repsonseJson: result6,
  };
  postReturn0(ret);
  return retVal;
}
...
const $init = (() => {
  let gen = (function* init () {
    ...
    postReturn0 = exports1['cabi_post_example:browser-fetch/ping#get-json'];
  })();
...
export { ping, ping as 'example:browser-fetch/ping',  }