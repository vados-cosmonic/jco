...
declare module 'bytecodealliance:jco-std/http-v0m2px' {
  ...
  export type * as WasiIoPoll024 from 'wasi:io/poll@0.2.4'; // import wasi:io/poll@0.2.4
  export type * as WasiIoStreams024 from 'wasi:io/streams@0.2.4'; // import wasi:io/streams@0.2.4
}
